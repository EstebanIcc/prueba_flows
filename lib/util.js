...
async function processImageFile({ file_url, company, user }) {
  try {
    ...
    const payload = {
      input: {
        file_url: "https://cdn.jelou.ai/video-frames/4276eab4-af2b-47da-94b2-415954fc0232.jpeg"
      },
      company,
      user
    };
...
async function callOpenAI({ imageFileUrl }) {
  try {
      ...
      input: [
        {
          ...
          content: [
            ...
            {
              type: "input_image",
              image_url: "https://cdn.jelou.ai/video-frames/4276eab4-af2b-47da-94b2-415954fc0232.jpeg"
            }
          ]
        }
      ]
    ...
    const response = await axios.post(url, payload, {
      headers: {
        'Authorization': `Bearer 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`,
        'Content-Type': 'application/json'
      },
...
async function imageAWS({ file_url }) {
  try {
    ...
    const apiKey = '2|bohy8XTwxvxicl637PYaCc9zRpMRDp9eqOcuS64lf2a16af4';
